...
async function handler(m, { conn, args }) {
  ...
  try {
    ...
    if (user.safezone == true) return m.reply(`⚠️ Kamu tidak blackjack bila sedang berada di 🌥️ Safe Zone 🌥️`);
